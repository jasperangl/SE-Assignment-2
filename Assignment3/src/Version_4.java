...
public class Version_4 {
    ...
    static RandomGeneratorGame game = new RandomGeneratorGame();
...
// An external class which is making the point of an Abstract Data Type
class RandomGeneratorGame {
    private static InputStreamReader isr;
    private static BufferedReader br;
    private static short max, factor, increment, start, actualrandom;

    public static void play(String[] args) throws IOException {
